                ...
                <div class="contentArea col-lg-7 py-4">
                    ...
                    <div class="searchBar tab-content">
						...
						<div id="searchCources" class="tab-pane fade">
                            ...
                            <form class="searchForm clearfix" role="form">
                                <input class="form-control" placeholder="Search State/City" id="searchStateCity" autocomplete="off"/>
                                ...
                                <input class="form-control" placeholder="Search Courses" id="searchCourse"  autocomplete="off" />
