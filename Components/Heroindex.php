    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="contentArea col-lg-7 py-4">
                ...
                <p>Get My University bring the power of data science and artificial intelligence to every NEET Aspirant
                </p>
            ...
            <div class="col-lg-5 text-center">
                <div class="imgBox d-none d-lg-block"><img src="images/main-hero2.png" alt="Abroad Journey" width="745"
                        height="636" /></div>
            </div>
        </div>
    </div>
