...
<!-- Mirrored from www.getmyuniversity.com/public/about-us by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Sep 2023 12:25:17 GMT -->
<!-- Added by HTTrack -->
...
<body>
    ...
    <section class="country_banner innerSlide">
        <div class="bg_img"><img data-src="..images/about-slide.jpg" width="1907"
                height="513" alt="" /></div>
        <div class="container">
            <div class="innerBox">
                <h1>About Us | </h1>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="text-justify">
                        <h2>GMU | Get My University</h2>
                        <p>Get My University (GMU) is India’s leading ISO Certified career counselling company assisting
                            aspirants for Medical Admissions in India & Abroad. We Assist medical aspirants for variety
                            of programs like MBBS, BDS, BAMS, MD, MS, DIPLOMA, MBBS Abroad, Nursing etc. </p>
                        <p>Team Get My University travel extensively for regular visits to the institutions, perform
                            detailed profile analysis and provide our clients with objective and micro details to
                            empower them in taking informed choices.</p>
                        <p>Get My University are aimed towards assisting aspirants in “Data Driven Systematic
                            Counselling” with a focus on their <b>“Individual Profiles.” </b>Our 360-degree assistance
                            to the Medical aspirants starting from the discovery phase to the final admission.</p>
                        <p>We believe in a transparent and process driven approach which assists
                            candidatessystematically in information assimilation to take an informed decision. GMU
                            Belief is all about “Empowering Talents & Nurturing Lives”</p>
                        <p><strong>We are the most Experienced ISO Certified Career Counseling Company</strong></p>

                        <ul>
                            <li>A venture of GMU Consulting Private Limited.</li>
                            <li>10 Years of Experience in the Education Sector.</li>
                            <li>Worked with 5000+ clients across the country.</li>
                            <li>One-stop-shop for Career Counseling needs.</li>
                            <li>India&rsquo;sleading &nbsp;ISO 9000:2015 certified company working exclusively in the
                                education space.</li>
                            <li>Highly Experienced Team with members from India&rsquo;s premier institutes.</li>
                        </ul>
                ...
                <div class="col-md-5">
                    <div class="guide_box">
                        <img class="img-fluid fade-in"
                            data-src="https://www.getmyuniversity.com/public/images/about-us.jpg" alt=""
    ...
    <section class="liveEvent section-padding  light-bg">
        <div class="container">
            <div class="row eventList">
                <div class="col-md-6">
                    <div class="eventBox">
                        <div class="imgBox">
                            <img class="img-fluid" src="images/mission.jpg" alt="">
                        </div>
                        <div class="textBox">
                            <h3>Our Mission</h3>
                            <p>Get My University aspire to render services with dignity, honesty and courtesy to
                                students, associates, employees and society at large. We aspire to help students to find
                                right career path thereby giving brilliant and unparallel experience to our students.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="eventBox">
                        ...
                        <div class="textBox">
                            <h3>Our Vision</h3>
                            <p>GMU vision is aimed towards delivering values to our students, empowering them with
                                verified information thereby transforming their lives.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="guide_box">
                        <img class="img-fluid fade-in"
                            data-src="https://www.getmyuniversity.com/public/images/admissions.png" alt=""
                            src="images/admissions.png">
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="text-justify">
                        <h2>GET MY UNIVERSITY APPROACH</h2>

                        <p>Medical Admission is a complex process and needs a great amount of pre-planning and a
                            professional approach that can match the RIGHT FIT FOR the RIGHT STUDENTS.</p>

                        <p><strong>Team Get&nbsp;My University assists medical aspirants in the following
                                ways:&nbsp;</strong></p>

                        <ul>
                            <li><strong>Explaining the Quality of the College</strong> which includes analysis of
                                Clinical Facts (Patient Inflow, Hospital Infrastructure, Departments, Location and
                                connectivity Academics, Student Amenities like a hostel, food, extracurriculars, etc.)
                            </li>
                            <li><strong>Proper budget planning </strong>by explaining hidden elements like charges,
                                annual increments in fees, Rural Service bonds, Bank guarantees, and Penalties.&nbsp;
                            </li>
                            <li>Give <strong>complete clarity about the Admission Process</strong> of multiple states
                                thereby preventing wrong choices with multiple registrations, and security fees thereby
                                making a huge waste of both money and precious time of Medical aspirants.</li>
                            <li><strong>Systematic analysis of past year Cutoffs</strong> and scientific trend analysis
                                about future cutoffs of respected colleges.&nbsp;</li>
                            <li>Planning the admission process to prevent any confusion such as multiple forms filling,
                                registration errors, domicile applicability, parallel counseling rounds, clash of dates,
                                etc.&nbsp;</li>
                        </ul>
                    ...
                    <div class="formBox">
                        ...
                        <form class="form" method="post" action="https://www.getmyuniversity.com/public/query"
                            ...
                            <input type="hidden" name="_token" value="YvoOqzc0Jwsr89Wrf6btBbhmRBaVe1CTbofzKk8N"> <input
                                type="hidden" name="current_url" value="about-us.html">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="one_number" id="one_number" value="48" />
                                <input type="hidden" name="two_number" id="two_number" value="16" />
                                <label class="label">which is Bigger 48 or 16 ?</label>
    ...
    <section class="ourProcess section-padding pb-3">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-sm-6 col-lg-3">
                    <div class="box text-center mb-5">
                        <div class="icon"><img src="images/Picture1.png" height="115"></div>
                        <!--                     <h3><span class="count-element">10</span>+</h3>-->
                        <p>Years of Experience</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="box text-center mb-5">
                        <div class="icon"><img src="images/Picture2.png" height="115"></div>
                        <!--                     <h3><span class="count-element">40</span>+</h3>-->
                        <p>University Partners</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="box text-center mb-5">
                        <div class="icon"><img src="images/Picture3.png" height="115"></div>
                        <!--                     <h3><span class="count-element">10</span></h3>-->
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="box text-center mb-5">
                        <div class="icon"><img src="images/Picture4.png" height="115"></div>
                        <!--                     <h3><span class="count-element">500</span>+</h3>-->
...
<!-- Mirrored from www.getmyuniversity.com/public/about-us by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Sep 2023 12:25:19 GMT -->
