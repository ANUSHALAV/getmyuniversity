                ...
                <div class="container w-75">
                    ...
                    <form action="" class="text-capitalize" enctype="multipart/form-data" method="post">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control py-2" id="exampleFormControlInput1"
                                placeholder="college name" name="college_name" value="<?php echo $row['college_name'] ?>">
                        </div>
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="form-label">college addres</label>
                            <input type="text" class="form-control py-2" id="exampleFormControlInput1"
                                placeholder="college addres" name="addres" value="<?php echo $row['addres'] ?>">
                        </div>

                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="form-label">fee per year(in lakh)</label>
                            <input type="number" class="form-control py-2" id="exampleFormControlInput1"
                                placeholder="fee per year" name="fee" value="<?php echo $row['fee_per_year'] ?>">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea type="text" class="form-control py-2" id="exampleFormControlInput1"
                                name="about_the_college" placeholder="about the college"
                                rows="10"><?php echo $row['about_the_college'] ?></textarea>
                        </div>
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="form-label">About the faculty</label>
                            <textarea type="text" class="form-control py-2" id="exampleFormControlInput1"
                                name="about_the_faculty" placeholder="about the faculty"
                                rows="10"><?php echo $row['about_the_faculty'] ?></textarea>
                        </div>
                        <div class="mb-4">
