...
<!-- Mirrored from www.getmyuniversity.com/public/mbbs-colleges by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Sep 2023 12:26:15 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta property="og:url" content="mbbs-colleges.html">
    <meta property="og:title" content="">
    <meta property="og:description" content="">
    <meta property="og:image" content="images/country_images/large/index.html">
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="mbbs-colleges.html">
    ...
    <link rel="canonical" href="mbbs-colleges.html">
...
<body>
        ...
        <div class="inner_wrapper">
            <div class="container">
                <ul class="breadcrumb_bar list-unstyled inline mb-2">
                    ...
                    <li class="breadcrumb-item">MBBS</li>
                </ul>
                <h1>MBBS</h1>
            </div>
        </div>
                    ...
                    <div class="formBox">
                        ...
                        <form class="form" method="post" action="https://www.getmyuniversity.com/public/query"
                            ...
                            <input type="hidden" name="_token" value="YvoOqzc0Jwsr89Wrf6btBbhmRBaVe1CTbofzKk8N"> <input
                                type="hidden" name="current_url" value="mbbs-colleges.html">
                            ...
                            <div class="form-group">
                                <input type="hidden" name="one_number" id="one_number" value="44" />
                                <input type="hidden" name="two_number" id="two_number" value="13" />
                                <label class="label">which is Bigger 44 or 13 ?</label>
    ...
    <script>
        $(document).ready(function () {
            let courseName = "<?php echo $_REQUEST['courseName'] ?>";
            let stateName = "<?php echo $_REQUEST['stateName'] ?>";
            function loadData() {
                $.ajax({
                    url: "allcollegebystateandcourse.php",
                    type: "POST",
                    data: {
