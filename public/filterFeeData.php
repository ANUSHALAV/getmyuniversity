...
$query = "";
if ($range == 5) {
    $query .= "SELECT * FROM `medical_in_india` WHERE `fee_per_year`<=500000";
} else if ($range == 10) {
    $query .= "SELECT * FROM `medical_in_india` WHERE `fee_per_year`>=500000 AND `fee_per_year`<=1000000";
} else if ($range == 15) {
    $query .= "SELECT * FROM `medical_in_india` WHERE `fee_per_year`>=1000000 AND `fee_per_year`<=1500000";
} else if ($range == 20) {
    $query .= "SELECT * FROM `medical_in_india` WHERE `fee_per_year`>=1500000 AND `fee_per_year`<=2000000";
} else if ($range == 30) {
    $query .= "SELECT * FROM `medical_in_india` WHERE `fee_per_year`>=2000000 AND `fee_per_year`<=3000000";
}else if ($range == 31) {
    $query .= "SELECT * FROM `medical_in_india` WHERE `fee_per_year`>=3000000";
}
